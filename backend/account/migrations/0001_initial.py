    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(help_text='Укажите номер телефона для связи', max_length=12, validators=[django.core.validators.RegexValidator(message='Проверьте корректно ли указан номер телефона', regex='^(\\+7|8)\\d{10}$')], verbose_name='Номер телефона')),
