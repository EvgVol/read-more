...
urlpatterns = [
    ...
    path("course/<slug:slug>/trainer/",
         cache_page(60 * 15)(CourseTrainerView.as_view()),
         name="course_trainer"),
    path("course/<slug:slug>/trainer/<module_id>/",
         cache_page(60 * 15)(CourseTrainerView.as_view()),
         name="course_trainer_module"),
    path("courses/",
    ...
    path('module/<int:module_id>/', ContentListView.as_view(),
         name="content_list"),  
    path('module/<int:module_id>/content/<model_name>/create/',
         ContentCreateUpdateView.as_view(), name='content_create'),
    path('module/<int:module_id>/content/<model_name>/<int:id>/',
         ContentCreateUpdateView.as_view(), name='content_update'),
