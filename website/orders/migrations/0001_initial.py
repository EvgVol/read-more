    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(help_text='Enter your shipping address', max_length=250, verbose_name='address')),
                ('postal_code', models.CharField(help_text='Enter your postal code', max_length=50, verbose_name='postal code')),
                ('city', models.CharField(help_text='Enter your city', max_length=100, verbose_name='city')),
                ...
                ('coupon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='coupons.coupon', verbose_name='coupon')),
            ],
            options={
                'verbose_name': 'order',
